return Def.ActorFrame {
        LoadActor(THEME:GetPathG("ScreenSelectMusic", "ScrollBG")) .. {
                InitCommand = function(self)
                        ...
                        self:zoomto(SCREEN_WIDTH + QuarkUnit(256).Horz,
                                    SCREEN_HEIGHT + QuarkUnit(64).Vert)
		   ...
		   self:draworder(100)
			...
			self:diffusealpha(0.8)
                ...
                InitCommand = function(self)
                        ...
                        self:xy(SCREEN_WIDTH - QuarkUnit(316).Horz,
                                QuarkUnit(12).Vert)
                end
        }, Def.BitmapText {
                Font = "Common normal",
                ...
                InitCommand = function(self)
                        ...
                        self:xy(SCREEN_WIDTH - QuarkUnit(184).Horz,
                                QuarkUnit(28).Vert)
                end
        }
}
